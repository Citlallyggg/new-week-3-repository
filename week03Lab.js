 ...
 * 
 * ↓ YOUR CODE HERE ↓ */
// *original input for question 2 returns with commas, no spaces*
// let reverseAlphabet = alphabetArray.reverse();
// let reverseAlphabetString = alphabetArray.toString();
// console.log(reverseAlphabetString);

alphabetArray.reverse();
console.log(alphabetArray.join(''));
// ^^ can be condensed to console.log(alphabetArray.reverse().join('');)
...
let myTodoList = [];
//Step 2:
myTodoList.push("Do Laundry", "Buy Groceries", "Walk my cat Apollo");
console.log(myTodoList);
//Step 3:
myTodoList.splice(1,1);
console.log(myTodoList);
//Step 4:
let yourTodoList = ["Pick up Jack from doggy daycare", "Go to gym at 7pm"];
...
function whichArrayIsLonger(array1, array2) {
       let firstCase = array1.length > array2.length;
       let secondCase = array1.length < array2.length;
       if(firstCase) {
              return array1;
       } else if(secondCase) {
              return array2;
